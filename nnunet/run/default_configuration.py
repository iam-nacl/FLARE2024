...
def get_default_configuration(modelsavename, network, task, network_trainer, plans_identifier=default_plans_identifier,
    ...
    output_folder_name = join(network_training_output_dir, network, task, modelsavename, network_trainer + "__" + plans_identifier)
