...
def main():
    ...
    for _, row in easy_samples.iterrows():
        ...
        dest_img_path = f"/data/FLARE24/data/nnUNet_raw_data_base/nnUNet_raw_data/Task114_FLARE_CurriculumSample0.90/imagesTr/Case_{case_num:05d}_0000.nii.gz"
        dest_label_path = f"/data/FLARE24/data/nnUNet_raw_data_base/nnUNet_raw_data/Task114_FLARE_CurriculumSample0.90/labelsTr/Case_{case_num:05d}.nii.gz"
