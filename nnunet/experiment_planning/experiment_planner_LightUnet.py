...
class ExperimentPlanner3D_LightUnet(ExperimentPlanner):
    """
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_LightUnet, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_LightUnet"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansLightUnet_plans_3D.pkl")
