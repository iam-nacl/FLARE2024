...
def main():
    ...
    if model == "3d_cascade_fullres" and lowres_segmentations is None:
        ...
        model_folder_name = join(network_training_output_dir, "3d_lowres", task_name, args.modelsavename, trainer_class_name + "__" +
                                 args.plans_identifier)
    ...
    #                           args.plans_identifier)
    model_folder_name = join(network_training_output_dir, model, task_name, args.modelsavename, trainer + "__" +
                             args.plans_identifier)
